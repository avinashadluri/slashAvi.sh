---
title: "React Server Components: The Mental Model Shift That Finally Clicked"
description: "What RSC actually changes, when server components make sense, and the 'aha' moment that rewired how I think about React."
---
