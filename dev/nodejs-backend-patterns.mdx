---
title: "Node.js Backend Patterns for TypeScript Engineers"
description: "Express, NestJS, and the patterns that make TypeScript backends maintainable — dependency injection, middleware, error handling, and API design."
---
